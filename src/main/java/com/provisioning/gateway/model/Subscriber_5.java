...
@Entity
@Table(name = "subscribers_5")
public class Subscriber_5 {
	@Id
	String a_party;
	int opr_type;
	...
	public Subscriber_5(String a_party, int opr_type, Timestamp created_date, int status, Timestamp status_update_dt,
			int service_id, Timestamp sub_date, String channel, Timestamp hlractivation_date, Timestamp unsub_date,
			String unsub_channel, Timestamp hlr_deactivation_date, Timestamp charge_dt, Timestamp next_charge_dt) {
		super();
