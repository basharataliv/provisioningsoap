...
@Entity
@Table(name = "subscribers_0")
public class Subscriber_0 {
	@Id
	String a_party;
	int opr_type;
	...
	public Subscriber_0(String a_party, int opr_type, Timestamp created_date, int status, Timestamp status_update_dt,
